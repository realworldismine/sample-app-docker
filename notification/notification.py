...
def notify_user():
    ...
    email_server_address = os.environ.get('email_server_address','smtp.gmail.com')
    email_server_from = os.environ.get('email_server_from','xinguifeng3@gmail.com')
    email_server_key = os.environ.get('email_server_key','ndfdezhukrftnqox')
